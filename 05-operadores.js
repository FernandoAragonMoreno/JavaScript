...
/*Según lo anterior haga un código que:
  a. Dado tres números (a,b,c) realice las siguientes operaciones e imprima el resultado.
    i.(a*b)/c
    ii.(b+c)*a
    iii.(a/b)-(a+c)*/
...
console.log(`(a1/b1)-(a1+c1): ${a1 / b1 - (a1 + c1)}`);
...
/*Según el código investigue si es posible realizar un incremento de más de una unidad.
  Si es posible realice un código de demostración.*/
